...
VALUES
    ...
    ('CATEGORY_MANAGEMENT', '카테고리 관리', 'Y', 1, 4, 'category', '', '카테고리 관리 메뉴', 'N', '58.140.215.148', 1, DATE_FORMAT(NOW(), '%Y%m%d%H%i%S')),
    ('CATEGORY_MANAGEMENT', '카테고리 관리', 'Y', 2, 1, 'category', '/cms/category/category/list', '카테고리 관리 메뉴', 'N', '58.140.215.148', 1, DATE_FORMAT(NOW(), '%Y%m%d%H%i%S')),
    ('BOARD_MANAGEMENT', '게시글 관리', 'Y', 1, 5, 'board', '', '게시글 관리 메뉴', 'N', '58.140.215.148', 1, DATE_FORMAT(NOW(), '%Y%m%d%H%i%S')),
    ('BOARD_MANAGEMENT', '게시글 관리', 'Y', 2, 1, 'board', '/cms/board/board/list', '게시글 관리 메뉴', 'N', '58.140.215.148', 1, DATE_FORMAT(NOW(), '%Y%m%d%H%i%S')),
    ('CODE_MANAGEMENT', '코드 관리', 'Y', 1, 6, 'code', '', '코드 관리 메뉴', 'N', '58.140.215.148', 1, DATE_FORMAT(NOW(), '%Y%m%d%H%i%S')),
